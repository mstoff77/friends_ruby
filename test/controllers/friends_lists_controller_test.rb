...
class FriendsListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friends_list" do
    assert_difference("FriendsList.count") do
      post friends_lists_url, params: { friends_list: { about: @friends_list.about, email: @friends_list.email, full_name: @friends_list.full_name, phone: @friends_list.phone, twitter: @friends_list.twitter } }
    end
  ...
  test "should update friends_list" do
    patch friends_list_url(@friends_list), params: { friends_list: { about: @friends_list.about, email: @friends_list.email, full_name: @friends_list.full_name, phone: @friends_list.phone, twitter: @friends_list.twitter } }
